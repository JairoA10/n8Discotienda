 ...
 * @throws FileNotFoundException - Cuando no existe la ruta especificacion del archivo a leer o escribir    
 */
    ...
    public void generarInformeDiscos() throws FileNotFoundException
    {
    	...
    	String generoDado = JOptionPane.showInputDialog("Digite un genero de musica");
    ...
    if(generoDiscoEncontrado > 0 && precioDiscoCostosoEncontrado > 0) {
    	JOptionPane.showMessageDialog(null, "Se encontro el disco con el genero ingresado");
    	
    }else if(generoDiscoEncontrado == 0 || precioDiscoCostosoEncontrado ==0) {
    	JOptionPane.showMessageDialog(null, "El disco ingresadp no cuenta con los datos para generar un informe");
    }
    pluma.close();
    }
